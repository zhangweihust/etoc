package com.zhangwei.speakloudly.account;
...
public class E2CAccountManager {
	...
	public E2CAccountManager(Context context){
	...
	private void prepareAccount(){
		Account[] accounts = mAccountManager.getAccountsByType(E2CAccount.ACCOUNT_TYPE);
	...
	public E2CAccount login(String userId, String number, String userName, String type, 
		...
		public void onAccountsUpdated(Account[] accounts) {
			if(mAccountAdapter == null){
				for(Account account : accounts){
					if(account.type.equals(E2CAccount.ACCOUNT_TYPE)){
						prepareAccount();
						publishLogin();
						break;
					}
	...
	public static interface OnLoginListener {
		...
		void onAccountLogin(E2CAccount account);
	...
	private class AccountAdapter implements E2CAccount{
		...
		public boolean isAirtel() {
			return E2CAccount.TYPE_AIRTEL.equals(mAccountManager.getUserData(mAccount, KEY_TYPE));
		}
